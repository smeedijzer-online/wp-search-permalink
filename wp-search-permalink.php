...
Description: Creëert een herschreven permalink voor de zoekpagina.
Version: 1.0.0
Author: Smeedijzer Internet
*/

class WP_Search_Permalink {

    const config_key = 'search_page_permalink';
    const default_value = 'zoeken';
    ...
    public function handle_plugin_settings() {
        ...
        add_settings_field(self::config_key, __('Zoekbasis', 'smdzr'), [$this, 'display_plugin_settings'], 'permalink', 'optional');
    }
